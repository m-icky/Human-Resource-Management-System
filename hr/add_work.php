			...
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					<tr>			
						...
						<th class="p-3 mb-2 bg-info text-light">Assign</th>
              ...
              <td><a class="btn btn-success py-2 px-3" href="assign.php?id=<?php echo $data['loginid']; ?>">Assign</a> </td>
              <!-- <td><a class="btn btn-danger py-2 px-3"  href="hr_delete.php?id=<?php echo $data['loginid']; ?>">Delete</a> </td> -->
						</tr> 
					<?php    
						}
					?>
