				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="contact-form">
							...
							<form method="post" action="assign_act.php" role="form">
                            <input class="input" type="hidden" name="id" required="" value="<?php echo $id?>" placeholder="Assign Work">
                                <input class="input" type="text" name="work" required="" placeholder="Assign Work">
