...
<section>
    <div class="container add-emp">		
			<center><h1 class="p-2 mb-0 bg-dark text-light"><strong>HR Details</strong></h1><br></center>
			<table class="table table-bordered table-hover">
              ...
              <td><a class="btn btn-success py-2 px-3" href="hr_update.php?id=<?php echo $data['id']; ?>">Update</a> </td>
