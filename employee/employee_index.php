		...
		<header id="header" class="transparent-nav">
			<div class="container">
				...
				<nav id="nav">
					...
					?>        
                    <li><td><a href="../employee/update_employee.php">Update-Profile</a> </td></li>
						</tr> 
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="single-blog">
                                    ...
                                    <h4><a href="view_work.php">Check Assigned Work</a></h4>
							...
							<div class="col-md-6">
								<div class="single-blog">
									...
									<h4><a href="view_salary.php">View Salary</a></h4>
