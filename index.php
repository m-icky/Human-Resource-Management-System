		...
		<div id="home" class="hero-area">
			...
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h1 class="white-text">Human Resource Management System</h1>
							<p class="lead white-text">Libris vivendo eloquentiam ex ius, nec id splendide abhorreant, eu pro alii error homero.</p>
							<a class="main-button icon-button" href="#section-header text-center">Get Started!</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div id="courses-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="reg.php" class="course-img">
									<img src="./img/course01.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="reg.php">Pro in Excel: Financial Modeling and Valuation</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">CSS Expert </a>
								<div class="course-details">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">The Ultimate Drawing </a>
								<div class="course-details">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">The Complete Web Development</a>
								<div class="course-details">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">PHP Tips, Tricks, and Techniques</a>
								<div class="course-details">
									<span class="course-category">Web Development</span>
								</div>
							</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">All You Need To Know About Web Design</a>
								<div class="course-details">
									<span class="course-category">Web Design</span>
								</div>
							</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">How to Get Started in Photography</a>
								<div class="course-details">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="reg.php">Typography From A to Z</a>
								<div class="course-details">
				...
				<div class="row">
					<div class="center-btn">
						<a class="main-button icon-button" href="reg.php">More Vacancies</a>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8 col-md-offset-2 text-center">
						...
						<p class="lead white-text">Human Resource Management System</p>
